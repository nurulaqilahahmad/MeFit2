        ...
        <div class="card">
          <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered">
              ...
              <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#schedule-settings">Edit Training Session</button>
              </li>
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-edit" id="profile-edit">
                <form method="post" action="/editTrainerProfile">
                  @csrf
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="trainerFullname" type="text" class="form-control" id="trainerFullname" value="{{$trainer->trainerFullname}}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="trainerUsername" type="text" class="form-control" id="trainerUsername" value="{{$trainer->trainerUsername}}">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <textarea name="trainerDescription" class="form-control" id="trainerDescription" style="height: 100px">{{$trainer->trainerDescription}}</textarea>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="trainerTelno" type="text" class="form-control" id="trainerTelno" value="{{$trainer->trainerTelno}}">
                    </div>
                  </div>
