...
<body>
    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="{{route('member_Index')}}" class="logo d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto" href="{{route('/member_Index#hero')}}">Home</a></li>
                    <li><a class="nav-link scrollto" href="{{route('/member_Index#pricing')}}">Membership Plan</a></li>
                    <li><a class="nav-link scrollto" href="{{route('/member_Index#team')}}">Training Session</a></li>
    ...
    <section class="breadcrumbs">
        <div class="container">
            <ol>
                <li><a href="{{route('/member_Index#pricing')}}">Home</a></li>
                <li><a href="{{route('member_TrainingSessionList')}}">Training Session</a></li>
                <li>Profile</li>
            </ol>
