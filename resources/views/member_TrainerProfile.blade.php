    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto" href="{{route('/member_Index')}}">Home</a></li>
                    <li><a class="nav-link scrollto" href="{{route('/member_Index')}}">Membership Plan</a></li>
                    <li><a class="nav-link scrollto" href="{{route('/member_TrainingSessionList')}}">Training Session</a></li>
