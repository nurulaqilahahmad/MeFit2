        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <p data-aos="fade-up">SIGN IN AS TRAINER</p>
                    <form id="login" method="post" action="/trainerSignIn">
                        ...
                        <span><a data-aos="fade-up" href="trainer_SignUp">Sign Up</a> </span>
                        <br> <br>

                        <span><a data-aos="fade-up" href="trainer_ForgotPassword">Forgot Password?</a> </span>
                        <br> <br>
                    </form>
