        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <p data-aos="fade-up">SIGN UP AS MEMBER</p>
                    <form id="login" method="post" action="/memberCreate">
                        ...
                        <br>
                        <input data-aos="fade-up" type="text" name="memberFullname" id="memberFullname" placeholder="Fullname" required="true">
                        <br>
                        ...
                        <br>
                        <input data-aos="fade-up" type="text" name="memberUsername" id="memberUsername" placeholder="Username" required="true">
                        <br>

                        <label data-aos="fade-up"><b>Telephone No.</b></label>
                        <br>
                        <input data-aos="fade-up" type="text" name="memberTelno" id="memberTelno" placeholder="Telephone No." required="true">
                        <br>
