...
<body>
    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="trainer_Index.html" class="logo d-flex align-items-center">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="box">
                        <img src="{{url('assets/img/workout.jpg')}}" class="img-fluid" alt="">
                        <h3>Unlimited Hit Classes</h3>
                        <span>Get your fit fix with HIIT classes monthly on top of your gym access; including
                            ...
                            You'll finish off sweatier and sexier than you've ever been before.</span>
                    </div>
                </div>
